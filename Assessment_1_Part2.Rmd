...
__*NOTE:*__ Only 6 rows is showing because there are 515 rows in-total.  Instead of scrolling through all 515 rows, I have used the head() function to only display the first 6 observations.  If you want to see the whole dataset, get rid of the head() function.
``` {r}
