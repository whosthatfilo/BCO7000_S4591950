...
As a summary of the plot, I have come to the conclusion that the Mcdonalds franchise sells low protein meals.  In fact, most of their items (food) is high in sugar and low in protein.
``` {r}
fastfood %>%
